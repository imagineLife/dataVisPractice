...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    if(config.waveRise){
        waveGroup.attr('transform','translate('+waveGroupXPosition+','+waveRiseScale(0)+')')
            ...
            // This transform is necessary to get the clip wave positioned correctly
            //  when waveRise=true and waveAnimate=false.
            //   The wave will not position correctly without this,
